...
gSamples = {
	...
	audio_sample_load("trollfaceeat.ogg"),
	audio_sample_load("upplatformmove.ogg"),
    audio_sample_load("s-level-up.ogg"),
    audio_sample_load("s-orb-1.ogg"),
    audio_sample_load("s-orb-2.ogg")
}
